...
BLOG_AUTHOR = "Gabriel Cristobal, Laurent Perrinet, Matthias S. Keil"  # (translatable)
BLOG_TITLE = "Biologically Inspired Computer Vision"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://bicv.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://bicv.github.io/"
BLOG_EMAIL = "laurent.perrinet@univ-amu.fr"
BLOG_DESCRIPTION = "Supporting material for the book"  # (translatable)
...
#         ("/rss.xml", "RSS feed"),
        ...
        ('https://laurentperrinet.github.io/publication/cristobal-perrinet-keil-15-bicv', 'Links'),#, 'icon-user'),
